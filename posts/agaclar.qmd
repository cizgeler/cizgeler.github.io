...
::: {.callout-tip collapse="true"}
## **İpucu**
Çelişkiyle ispat yöntemini deneyin ve çizgenin bir kapsayan ağacını düşünün.
:::
...
8. Sonuç 2.2.3'ün dikkatli bir ispatını verin: Bir çizge, ancak ve ancak herhangi iki köşe arasında en fazla bir yol varsa bir ormandır. Her iki yön için de karşıt tersini kullanarak ispat yapın (çelişkiyle ispat değil).

::: {.callout-tip collapse="true"}
## **İpucu**
Önerme 2.2.2'nin ispatını incelemek, ihtiyacınız olanın çoğunu size verecektir, ancak yalnızca ilgili kısımları verdiğinizden ve çelişkiyle ispat kullanmadığınızdan emin olun.
:::
